...
export default function CcSchedule({ groups }: Props) {
  ...
  return (
    <div className="w-full flex justify-center px-4 md:px-8 mt-6 md:mt-8 mb-12 md:mb-20">
      <div
        className="w-full max-w-[900px] border border-[#F4AB00]/40 rounded-[20px] md:rounded-[24px] px-1 py-6 md:px-14 md:py-12"
        style={{
          background:
