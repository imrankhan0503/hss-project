  ...
  return (
    <section className="bg-primary px-6 py-12 md:py-16">
      <div className="w-full mx-auto flex flex-col items-center text-center">
        ...
        <Link href='/anmal-intresse' className="mt-8 py-3 md:py-4 px-10 md:px-14 bg-secondary border-2 border-secondary rounded-full text-primary text-xl font-bold hover:border-secondary hover:bg-background hover:text-secondary">Anmäl intresse </Link>
      </div>
    </section>
  )
}
