  ...
  return (
    <>
      <div className={`${color} rounded-[20px] md:rounded-3xl px-6 py-8 md:py-10 flex flex-col items-center text-center min-h-[320px] md:min-h-96 shadow-[0px_10px_20px_rgba(0,0,0,0.05)]`}>
        ...
        <Link href={href} className="mt-auto bg-secondary text-primary text-base font-medium rounded-full px-6 py-2 md:px-6 md:py-4 hover:bg-primary hover:text-background">{`${t('homepage.groups.buttonText', lang)} ${title.toLowerCase()}`}</Link>
      </div>
    </>
  )
}
