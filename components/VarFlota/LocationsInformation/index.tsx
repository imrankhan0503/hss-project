...
const LocationsInformation = () => {
  ...
  const locations = [
    {
      id: "ruffen",
      label: t('mapsection.navigation.ruffen', lang),
      title: t('mapsection.ruffen.title', lang),
      address: t('mapsection.ruffen.address', lang),
      description: t('mapsection.ruffen.description', lang),
    ...
    {
      id: "myset",
      label: t('mapsection.navigation.myset', lang),
      title: t('mapsection.myset.title', lang),
      address: t('mapsection.myset.address', lang),
      description: t('mapsection.myset.description', lang),
    ...
    {
      id: "båtklubben",
      label: t('mapsection.navigation.boatclub', lang),
      title: t('mapsection.boatclub.title', lang),
      address: t('mapsection.boatclub.address', lang),
      description: t('mapsection.boatclub.description', lang),
    ...
    {
      id: "varvet",
      label: t('mapsection.navigation.boatyard', lang),
      title: t('mapsection.shipyard.title', lang),
      address: t('mapsection.shipyard.address', lang),
      description: t('mapsection.shipyard.description', lang),
    ...
    <section className="w-full md:mb-20 md:px-28">
      <div className="mx-auto max-w-300">
        <div className="mb-6 flex items-center justify-center gap-3 md:justify-start">
          <Image
            src={LocationIcon}
            alt={t('mapsection.title', lang)}
            className="w-8"
          />

          <h2 className="text-2xl font-bold text-primary">
            {t('mapsection.title', lang)}
          </h2>
        </div>
