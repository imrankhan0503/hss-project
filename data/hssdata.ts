  ...
  sv: [
    ...
    },
    {
      ...
      activities: [
        ...
        "Pyssel och skapande",
        "Sagor om Parum och Magna",
        "Gemensamma aktiviteter för hela familjen",
      ],
      badges: ["Familjescoutmärket", "Temamärken", "Samhörighetsmärken"],
      meetingDays: "Måndagar",
      meetingTime: "18:30–20:00",
      meetingPlace: "Scoutlokalen Ruffen (Hässelby Strand)",
      leader: "Abcxxx",
      description:
        "Familjescouting är till för barn under åtta år tillsammans med en eller flera vuxna. Här får hela familjen upptäcka scouting tillsammans genom lek, äventyr och gemensamma upplevelser.\n\nMed hjälp av berättelserna om björnarna Parum och Magna får barn och vuxna utforska naturen, prova nya aktiviteter och lära känna varandra på ett lekfullt sätt.\n\nFamiljescouting handlar om att ha roligt tillsammans, skapa nya vänskaper och lägga grunden för ett fortsatt scoutliv.\n\nFamiljescouterna träffas regelbundet för gemensamma aktiviteter.",
    },
  ],
  en: [
    {
      ...
      activities: [
        ...
        "Overnight stays",
        "Apply bandages",
        "Sail optimist dinghies",
        "Cooperate in patrols",
      ],
      badges: [
        "Lantern badge",
        "Entertainment",
    ...
    },
    {
      ...
      activities: [
        ...
        "Nature exploration",
        "Games and play",
        "Stories about Parum and Magna",
        "Shared activities for the whole family",
      ],
      badges: ["Family Scout badge", "Theme badges", "Belonging badges"],
      meetingDays: "Monday",
      meetingTime: "18:30–20:00",
      meetingPlace: "Scout hall Ruffen (Hässelby Strand)",
      leader: "Abcxxx",
      description:
        "Family Scouting is intended for children under the age of eight together with one or more adults. Here, the whole family discovers scouting together through play, adventure, and shared experiences.\n\nWith the help of stories about the bears Parum and Magna, children and adults explore nature, try new activities, and get to know each other in a playful way.\n\nFamily Scouting is about having fun together, making new friends, and laying the foundation for a continued scouting journey.\n\nFamily Scout groups meet regularly for shared activities.",
    },
  ],
};
